...
def predict(data_type, seq_length, saved_model, image_shape, video_name, class_limit):
    ...
    if image_shape is None:
        ...
        # data = DemoSet(seq_length=seq_length, class_limit=class_limit)
    else:
        data = DataSet(seq_length=seq_length, image_shape=image_shape,
            class_limit=class_limit)

        # data = DemoSet(seq_length=seq_length, image_shape=image_shape,
        #     class_limit=class_limit)
        print(data)
...
def main():
    ...
    saved_model = 'data/checkpoints/lstm-features.030-0.032.hdf5'
    # saved_model = 'data/checkpoints/lstm-features.050-0.603.hdf5'
    # saved_model = 'data/checkpoints/lstm-features.025-0.195.hdf5'
    ...
    print(" C L A S S I F Y I N G \"" + video_name + "\" . . .")
